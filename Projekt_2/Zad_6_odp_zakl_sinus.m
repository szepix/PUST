...
xlabel("k")
ylabel("y")
title("Odpowiedz skokowa ukladu z regulatorem DMC oraz z zakloceniem sinusoidalnym" + newline + "D = " + D + " N = " + N + " Nu = " + Nu +  " lambda = " + lamb + " error = " + e + " Dz = " + Dz)
...
ylim([-1 2])
if sav
    name = sprintf("Zakl_DMC_sin_Dz_%i.pdf",Dz);
