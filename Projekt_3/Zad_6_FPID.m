...
for k = kp:kk
    ...
    if il == 2
        U_now = (U_1 * w(1,k) + U_2 * w(2,k))/(sum(w(:,k))*2);
    elseif il == 3
        U_now = (U_1 * w(1,k) + U_2 * w(2,k) + U_3 * w(3,k))/(sum(w(:,k))*3);
    elseif il == 4
        U_now = (U_1 * w(1,k) + U_2 * w(2,k) + U_3 * w(3,k) + U_4 * w(4,k))/(sum(w(:,k))*4);
    elseif il == 5
        U_now = (U_1 * w(1,k) + U_2 * w(2,k) + U_3 * w(3,k) + U_4 * w(4,k) + U_5 * w(5,k))/(sum(w(:,k))*5);
    end
